...
В данном проекте отработаны следующие аспекты темы **Исследовательский анализ данных**:  
- Введение в исследовательский анализ данных(знакомство с библиотеками SciPy и Matplotlib)  
